...
<body class="bg-gradient-primary">
    ...
    <script>
        ...
        document.querySelector(".login-with-google").addEventListener("click", function(event) {
            event.preventDefault();
            alert("Login with Google feature is coming soon!");
            window.location.href = "index.html";
        });

        document.querySelector(".login-with-facebook").addEventListener("click", function(event) {
            event.preventDefault();
            window.location.href = "index.html";
        });
    </script>
